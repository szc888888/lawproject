...
import io.renren.oss.validator.AliyunGroup;
import io.renren.oss.validator.BaiduGroup;
import io.renren.oss.validator.QcloudGroup;
import io.renren.oss.validator.QiniuGroup;
...
public class CloudStorageConfig implements Serializable {
    ...
    // 百度BOS配置
    @ApiModelProperty(value = "百度云EndPoint")
    @NotBlank(message="{aliyun.endPoint.require}", groups = BaiduGroup.class)
    private String baiduEndPoint;

    @ApiModelProperty(value = "百度云AppId")
    @NotNull(message="{qcloud.appid.require}", groups = BaiduGroup.class)
    private String baiduAccessKeyId;

    @ApiModelProperty(value = "百度云AccessKeySecret")
    @NotBlank(message="{aliyun.accesskeysecret.require}", groups = BaiduGroup.class)
    private String baiduSecretAccessKey;

    @ApiModelProperty(value = "百度云BucketName")
    @NotBlank(message="{qcloud.bucketname.require}", groups = BaiduGroup.class)
    private String baiduBucketName;

    @ApiModelProperty(value = "百度云绑定的域名")
    @NotBlank(message="{qcloud.domain.require}", groups = BaiduGroup.class)
    @URL(message = "{qcloud.domain.url}", groups = BaiduGroup.class)
    private String baiduDomain;

    @ApiModelProperty(value = "百度云路径前缀")
    private String baiduPrefix;
