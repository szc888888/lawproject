...
import io.renren.modules.sys.excel.CommodityExcel;
...
public class CommodityController {
    ...
    @RequiresPermissions("sys:commodity:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("sys:commodity:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("sys:commodity:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("sys:commodity:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("sys:commodity:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("sys:commodity:export")
